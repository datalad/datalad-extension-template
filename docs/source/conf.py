# -*- coding: utf-8 -*-
#
# datalad_publicneuro documentation build configuration file, created by
        ...
        try:
            subprocess.run(
                args=[setup_py_path, 'build_manpage',
                     '--cmdsuite', 'datalad_publicneuro:command_suite',
                     '--manpath', abspath(opj(
...
# built documents.
version = datalad_publicneuro.__version__
release = version
